...
export function connectSocket() {
  ...
  currentSocket.onopen = () => { if (socket !== currentSocket) return; setStatus("CONNECTED"); queueIds.forEach((queueId) => currentSocket.send(JSON.stringify({ type: "subscribe", queueId }))); };
